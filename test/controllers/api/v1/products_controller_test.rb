...
module Api
  module V1
    class ProductsControllerTest < ActionDispatch::IntegrationTest
      ...
      test 'shoud show products' do
        get api_v1_products_url, as: :json
        assert_response :success
      end

      test 'shoud create product' do
        assert_difference('Product.count') do
          post api_v1_products_url, params: { product: { title: 'third', price: 1000, published: true } },
                                    headers: { Authorization: JsonWebToken.encode(user_id: @product.user_id) }, as: :j
        end
        assert_response :created
      end

      test 'should prohibt create product' do
